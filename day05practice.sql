...
insert into child values (101,2000,'Araba','Leyla');

--SORU 2: .child tablosuna ted_verginosu 105 olan veri girişi yapınız.
--paraent tabloda olmayan primary key ile child tabloya veri girişi yapılmaz.105 olmadığı için çözülemez
insert into child values(105,3000,'Motor','Haşim');-- bu sebeple bu kod çalışmaz
...
delete from parent where vergi_no=101;--eror verdi
...
--ON DELETE CASCADE SAYESİNDE SİLEBİLDİK
delete from parent2;
