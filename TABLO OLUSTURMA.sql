...
INSERT INTO ogrenciler7 VALUES ('1234567','Leyla','yıldız',95.5,now());
INSERT INTO ogrenciler7 VALUES ('12345678','Humanur','yıldız',85.5,now());
INSERT INTO ogrenciler7 (ogrenci_no,soyisim,not_ort) VALUES ('1234569','Leyla',85.5);
--NOT NULL KISITLAMASI OLDUĞU İÇİN VERİ EKLENEMEZ
...
INSERT INTO adresler VALUES('10012','Ağa Sok', '30.Cad.','Antep');--parent tabloda olmadığı için göstermez
...
--Calisanlar tablosundan maaşı 5000 den buyuk olanlar isimleri listeleyiniz
...
--DML -- DELETE KOMUTU
DELETE FROM calisanlar;-- Eger parent table başka bir child tablo ile ilişkili ise önce child tablo silinmelidir
DELETE FROM adresler; --çalıştırırsak adresler tablosunun içi boşalır.
SELECT * FROM adresler;-- bunu çalıştırırsam boş çalışır
